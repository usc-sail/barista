...
FasterOnlineDecoder::FasterOnlineDecoder(const fst::Fst<fst::StdArc> &fst,
                                         const FasterOnlineDecoderOptions &opts): fst_(fst), config_(opts) {
...
void FasterOnlineDecoder::InitDecode() {
...
bool FasterOnlineDecoder::ReachedFinal() {
...
bool FasterOnlineDecoder::GetBestPath(fst::MutableFst<LatticeArc> *fst_out) {
...
BaseFloat FasterOnlineDecoder::GetCutoff(Elem *list_head, size_t *tok_count,
...
void FasterOnlineDecoder::PossiblyResizeHash(size_t num_toks) {
...
BaseFloat FasterOnlineDecoder::ProcessEmitting(DecodableInterface *decodable, int frame) {
...
void FasterOnlineDecoder::ProcessNonemitting(BaseFloat cutoff) {
...
void FasterOnlineDecoder::ClearToks(Elem *list) {
